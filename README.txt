...
a persistence unit "eva62japaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62japa/pom.xml":
...
artifact ("eva62japa.war") is already built. You can build
